...
/**4-1项目磨块图片**/
CREATE TABLE HOME_proj_sh(
	sid INT PRIMARY KEY AUTO_INCREMENT,  #编号
	content VARCHAR(1000)			#内容
	);

/**4-1插入项目磨块图片数据**/
INSERT INTO HOME_proj_sh VALUES
...
/**4-2项目磨块图片**/
CREATE TABLE HOME_proj_art(
	sid INT PRIMARY KEY AUTO_INCREMENT,  #编号
	content VARCHAR(1000)			#内容
	);

/**4-2插入项目磨块图片数据**/
INSERT INTO HOME_proj_art VALUES
	(NULL,'public/imges/portfolio2.jpg'),
	(NULL,'public/imges/portfolio3.jpg'),
	(NULL,'public/imges/portfolio4.jpg'),
	(NULL,'public/imges/portfolio5.jpg');
...
/**4-3项目磨块图片**/
CREATE TABLE HOME_proj_de(
	sid INT PRIMARY KEY AUTO_INCREMENT,  #编号
	content VARCHAR(1000)			#内容
	);

/**4-3插入项目磨块图片数据**/
INSERT INTO HOME_proj_de VALUES
	(NULL,'public/imges/portfolio6.jpg'),
	(NULL,'public/imges/portfolio7.jpg'),
	(NULL,'public/imges/portfolio8.jpg'),
	(NULL,'public/imges/portfolio9.jpg');
...
/**4-4项目磨块图片**/
CREATE TABLE HOME_proj_na(
	sid INT PRIMARY KEY AUTO_INCREMENT,  #编号
	content VARCHAR(1000)			#内容
	);

/**4-4插入项目磨块图片数据**/
INSERT INTO HOME_proj_na VALUES
	(NULL,'public/imges/portfolio2.jpg'),
	(NULL,'public/imges/portfolio3.jpg'),
	(NULL,'public/imges/portfolio4.jpg'),
	(NULL,'public/imges/portfolio5.jpg');
...
/**9-2插入FORM模板**/
CREATE TABLE HOME_aform(
	sid INT PRIMARY KEY AUTO_INCREMENT,  #编号
	name VARCHAR(1000),				#姓名
...
/**9-2插入FORM模板**/
INSERT INTO HOME_aform VALUES
	(NULL,'马美华','1245718734@qq.com','项目方案','What to speak directly to us, we are here and waiting合作愉快！');

/**10插入邮箱**/
CREATE TABLE HOME_emaie(
	sid INT PRIMARY KEY AUTO_INCREMENT,  #编号
	uname VARCHAR(1000),				#用户
	upwd VARCHAR(1000)				#密码
);

/**10插入邮箱模板**/
INSERT INTO HOME_emaie VALUES
	(NULL,'mmh','124578');